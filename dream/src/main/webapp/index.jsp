		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<h1 class="animated fadeInUp mb-5">꿈과 환상의 나라로 <br>여러분을 초대합니다!555555 <br></h1>
		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card bg-transparent border-0">
					<img src="images/blog/tc.jpg" alt="" class="img-fluid rounded">
			...
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
					<img src="images/blog/bc.jpg" alt="" class="img-fluid rounded">

					<div class="card-body mt-2">
						<div class="blog-item-meta">
							<span class="ml-2 mr-2">오시는길</span>
						</div>  
			...
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
					<img src="images/blog/dr.jpg" alt="" class="img-fluid rounded">
