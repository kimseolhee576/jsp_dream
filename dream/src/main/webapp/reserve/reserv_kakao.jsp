    ...
    $(function(){
        ...
        IMP.request_pay({
            ...
            if ( rsp.success ) {
                ...
                //성공시 이동할 페이지
                alert("결제가 완료되었습니다. 예매내역페이지로 이동합니다.");
                location.href="http://localhost:9000/dream/reserve/reserv_result.jsp";
            } else {
                msg = '결제에 실패하였습니다.';
                msg += '에러내용 : ' + rsp.error_msg;
                //실패시 이동할 페이지
                location.href="http://localhost:9000/dream/reserve/reserv_check.jsp";
                alert(msg);
            }
        });
